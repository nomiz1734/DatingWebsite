    ...
    <div class="container py-5">
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="card mb-4">
                    <div class="card-body">
                        <h4 class="text-center">List report</h4>
                        <div class="row">
                                <div class="col-sm-2">
                        ...
                        <c:forEach var="report" items="${sessionScope.reportList}">
                            <div class="row">
                                <div class="col-sm-2">
                                    <p class="text-muted mb-0">${report.username}</p>
                                </div>
                                <div class="col-sm-4">
                                    <p class="text-muted mb-0">${report.username_reported}</p>
                                </div>
                                <div class="col-sm-3">
                                    <p class="text-muted mb-0">${report.reason}</p>
                                </div>
                                <div class="col-sm-3">    
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a class="btn btn-warning" href="warninguser?userwa=${report.username}">Warning user</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
