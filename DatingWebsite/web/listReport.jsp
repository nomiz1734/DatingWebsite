            ...
            <div class="col">
                <nav aria-label="breadcrumb" class="bg-body-tertiary rounded-3 p-3 mb-4">
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">List people you reported</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <c:forEach var="userreport" items="${sessionScope.reportList}">
                            <div class="row">
                                <div class="col-sm-3">
                                    <p class="mb-0">${userreport.username_reported}</p>
                                </div>
                                <div class="col-sm-1">
                                    <p class="mb-0">|</p>
                                </div>
                                <div class="col-sm-8">
                                    <p class="text-muted mb-0">${userreport.reason}</p>
                                </div>
                            </div>
                            <hr>
                        </c:forEach>
